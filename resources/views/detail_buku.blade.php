            ...
            <div class="dark:bg-gray-800 overflow-hidden rounded-lg shadow-md m-5">
                <section id="album" class="py-4 text-center bg-light">
                    <div class="container mx-auto">
                        ...
                        <hr class="my-2">
                        <div class="mb-4">
                            <p><span class="font-bold">Penulis:</span> {{ $bukus->penulis }}</p>
                            <p><span class="font-bold">Harga:</span> {{ $bukus->harga }}</p>
                            <p><span class="font-bold">Tanggal Terbit:</span> {{ $bukus->tgl_terbit }}</p>
                        </div>
